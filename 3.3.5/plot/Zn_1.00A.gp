...
Shadecolor = "#80E0A080"
Inputfile = "plot/Zn_1.00A.csv"


f(x) = k*x
fit f(x) Inputfile using 3:6 via k

plot Inputfile using 3:6:5:7 with xyerrorbars ls -1 linecolor rgb 'red' title "Измерения $U_{\\perp}(B)$",\

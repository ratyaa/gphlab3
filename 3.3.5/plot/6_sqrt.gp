...
f(x) = k*x + b
fit f(x) Inputfile using 10:3 via k, b

plot Inputfile using 10:3:11:5 with xyerrorbars ls -1 linecolor rgb 'red' title "Измерения $B(\\sqrt{I_M})$",\

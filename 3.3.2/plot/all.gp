...
Shadecolor = "#80E0A080"
Inputfile = "plot/all.csv"

f(x) = k*x
fit f(x) Inputfile using 6:3 via k

plot Inputfile using 6:3:7:4 with xyerrorbars ls -1 linecolor rgb 'red' title "Измерения $I (U^{\\frac{3}{2}})$ при $U > 10$ для всех $I_н$",\

...
Shadecolor = "#80E0A080"
Inputfile = "plot/14Agay.csv"

f(x) = k*x
fit f(x) Inputfile every ::17::25 using 6:3 via k

plot Inputfile using 6:3:7:4 with xyerrorbars ls -1 linecolor rgb 'red' title "Измерения $I (U^{\\frac{3}{2}})$",\

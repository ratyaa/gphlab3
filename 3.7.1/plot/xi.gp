...
Shadecolor = "#80E0A080"
Inputfile = "plot/xi.csv"

f(x) = k*x + b
fit f(x) Inputfile using 4:5 via k, b

plot Inputfile using 4:5:6:7 with xyerrorbars ls -1 linecolor rgb 'red' title "Измерения $\\frac{1}{\\xi^2}(\\nu^2)$",\

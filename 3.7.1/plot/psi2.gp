...
Shadecolor = "#80E0A080"
Inputfile = "plot/psi2.csv"

f(x) = k*x + b
fit f(x) Inputfile using 7:6 via k, b

plot Inputfile using 7:6:9:8 with xyerrorbars ls -1 linecolor rgb 'red' title "Измерения $\\psi(\\sqrt{\\nu})$",\
